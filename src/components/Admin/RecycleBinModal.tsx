  ...
  return (
    <div className="modal-overlay" onClick={() => setShow(false)}>
      <div 
        ...
        style={{ maxWidth: '1000px', width: '95%', maxHeight: '90vh', display: 'flex', flexDirection: 'column', padding: 0, overflow: 'hidden' }}
      ...
      >
        ...
        {/* 可滾動內容區 - 延伸至底部 */}
        <div style={{ flex: 1, overflowY: 'auto', padding: '1.5rem 2rem 6rem 2rem', position: 'relative' }}>
          {rows.length === 0 ? (
        ...
        <div style={{ 
          ...
          right: 0, 
          padding: '2rem', 
          background: 'linear-gradient(to top, var(--card-bg) 20%, transparent 100%)', 
          display: 'flex', 
          justifyContent: 'center',
