        ...
        >
          ...
          >
            ...
            >
              ...
              <span>
                {auditTarget.row[6]} 份 / {auditTarget.row[7]} 人
              </span>
            </p>
            <p
              style={{
            ...
            {(String(auditTarget.row[9]).includes('銀行轉帳') ||
              String(auditTarget.row[9]).includes('ATM')) && (
              <p
                style={{
                  margin: '0.5rem 0 0 0',
          ...
          <div style={{ marginTop: '1.5rem', padding: '0 0.5rem' }}>
            ...
            >
              ...
              <strong
                style={{ color: 'var(--primary-gold)', fontSize: '1.3rem' }}
              >
                NT$ {auditTarget.row[8]}
              </strong>
            </p>
            <p
              style={{
